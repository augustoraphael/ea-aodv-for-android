...
public interface Constants {
	...
	// user package max size equivalent 2.5Kb
	public static final int MAX_PACKAGE_SIZE = 2500;
	
	// AODV PDU types
	public static final byte RERR_PDU = 6;
	...
	//energy constants
	public static final int PRIMEIRO_LIMIAR = 15;
	public static final int SEGUNDO_LIMIAR = 5;
