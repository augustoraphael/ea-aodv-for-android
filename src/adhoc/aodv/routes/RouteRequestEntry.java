 ...
 */
	public RouteRequestEntry(int broadcastID, int sourceAddress, int destinationSequenceNumber, int hopCount, int destinationAddress, int routeCost) throws RouteNotValidException{
		super(hopCount, destinationSequenceNumber,destinationAddress, routeCost);
