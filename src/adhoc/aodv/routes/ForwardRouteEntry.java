...
public class ForwardRouteEntry extends RouteEntry {
    ...
    public ForwardRouteEntry(int destAddress, int nextHopAddress, int hopCount, int destSeqNum, ArrayList<Integer>  precursorNodes, float routeCost) throws RouteNotValidException {
    	super(hopCount, destSeqNum, destAddress, routeCost);
